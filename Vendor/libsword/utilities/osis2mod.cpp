 ...
 *
 * $Id: osis2mod.cpp 3914 2025-08-11 20:02:39Z dmsmith $
 *
...
void writeEntry(SWBuf &text, bool force = false) {
	...
	if (firstCall) {
		revision.setFormatted("<milestone type=\"x-importer\" subType=\"x-osis2mod\" n=\"$Rev: 3914 $ (SWORD: %s)\"/>", SWVersion::currentVersion.getText());
...
int main(int argc, char **argv) {
	...
	fprintf(stderr, "You are running osis2mod: $Rev: 3914 $ (SWORD: %s)\n", SWVersion::currentVersion.getText());
